  ...
  return (
    <div className="w-60 h-96 mb-10">
      <div className="relative">
        ...
        />
        <div className="flex justify-between px-5 absolute top-5 left-0 w-full">
      ...
      <p className="text-[#9CA3AF] text-xs mt-3">USA, 2016 - Current</p>
      <h6 className="mt-3 font-bold text-lg">Stranger Things</h6>
      ...
      <p className="text-[#9CA3AF] mt-3">Action, Adventure, Horror</p>
    </div>
  );
};
